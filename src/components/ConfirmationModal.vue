...
<template>
  <div
    ...
    <!-- Modal -->
    <div
      class="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md p-6 transform transition-all scale-100 animate-fade-in border border-gray-200/50 dark:border-gray-700/50">
      <div class="flex items-start gap-4">
        <div
          class="p-3 rounded-full bg-rose-100 dark:bg-rose-900/30 text-rose-600 dark:text-rose-400">
