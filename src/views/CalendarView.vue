...
const calendarDays = computed(() => {
  ...
  const days: Array<{ date: Date; isCurrentMonth: boolean; tasksCount: number; completedCount: number }> = [];
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex items-center gap-2 glass-card px-2 py-1.5 rounded-xl">
          ...
          <span class="px-4 text-sm font-semibold text-gray-900 dark:text-gray-100 capitalize min-w-[180px] text-center">
            {{ monthName }}
          </span>
              ...
              <div class="flex flex-col items-center justify-center h-full">
                ...
                <div v-if="day.tasksCount > 0" class="flex gap-0.5">
                  <div
                    ...
                    :class="i <= day.completedCount ? 'bg-green-500' : 'bg-indigo-500'">
                  </div>
                  <span v-if="day.tasksCount > 3" class="text-[8px] ml-0.5">+</span>
                </div>
              </div>
      ...
      <div class="lg:col-span-1">
        <div class="glass-card rounded-2xl p-6 sticky top-24">
          <div v-if="selectedDate" class="space-y-4">
            <div class="flex items-center gap-3 mb-4 pb-4 border-b border-gray-200/30 dark:border-gray-700/30">
            ...
            <!-- Tasks List -->
            <div v-if="selectedDayTasks.length > 0" class="space-y-2 max-h-[500px] overflow-y-auto">
              <div
                ...
                <div class="flex items-start gap-2">
                  <input
                    ...
                    :class="task.completed ? 'bg-indigo-500' : 'bg-transparent'"
                  />
